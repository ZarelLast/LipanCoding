...
$vip_business_slider_args = vip_business_get_section_args( 'slider' );

$vip_business_loop = new WP_Query( $vip_business_slider_args );
	...
	<article id="post-<?php echo esc_attr( get_the_ID() ); ?>" class="swiper-slide type-post caption-animate text-alignleft <?php echo has_post_thumbnail() ? 'has-post-thumbnail' : ''; ?>">
		<div class="slider-image-wrapper">
			...
			if ( has_post_thumbnail() ) {
				the_post_thumbnail( 'vip-business-slider' );
			} else {

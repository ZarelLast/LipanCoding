...
<div class="gt-right">			
        <div>				
            ...
            <a href="<?php echo esc_url( ELEVATION_LITE_PROTHEME_URL ); ?>"><?php esc_html_e('Purchase Pro', 'elevation-lite'); ?></a> | 
